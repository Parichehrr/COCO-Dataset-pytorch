...
# create train data loader
    train_dataset = cocodataset('root', '/path/train.txt', transform=transforms.Compose(train_transforms))
    ...
    test_dataset = cocodataset('root', 'path/test.txt', transform=transforms.Compose(val_transforms))
